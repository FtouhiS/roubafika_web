...
public class MailerApi {
     public void sendMail(Reponse reponse , String mail ) throws Exception {
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "																							style=\"color:#2190e3;font-size:34px;\">"+reponse.getDescriptionRep()+"</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
                ...
                + "																				by : "+reponse.getDescriptionRep()+"</span></p>\n"
                + "																		<p\n"
