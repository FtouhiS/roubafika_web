...
public class MailSender {
     public static void sendMail(String mail ,String contenu) throws Exception {
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "																							TO\n"
                + "																							Robafika</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                ...
                + "																				mail contains Your Reclamation .</span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																		style=\"font-size:18px;color:#000000;\">"+contenu+"<br>\n"																	
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br>\n"
                + "																				"+"<br>Reclamation Date : "+Date.valueOf(LocalDate.now())+"<br> </span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br>:<br> Company name : "+"Robafika"+"</span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                ...
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			Robafika © -  Your favorite company tool.\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			Tunis, Tunisia.</p>\n"
                ...
                + "																					:\n"
                + "																					Robafika@gmail.com</strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recipient , String mailContent) {
        try {
            ...
            message.setSubject("Welcome to Robafika");
