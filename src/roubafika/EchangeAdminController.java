...
public class EchangeAdminController implements Initializable {
    ...
    public void initData(int idUser , int id_produit ,int id_produitOffre ,int id_echange) throws SQLException {
        ...
        //Remplir les champs du livreur
        CRUDEchange crEchange = new CRUDEchange();
        Echange e = crEchange.afficherEchangeById(id_echange);
        Utilisateur livreur = crUser.rechercheUserbyid(e.getLivreur());
        NomLivreur.setText(livreur.getNom());
        System.out.println("---------------------------");
        System.out.println(livreur.getNumero_telephone() + livreur.getNom());
        System.out.println("----------------------------");
        TelLivreur.setText(Integer.toString(livreur.getNumero_telephone()));
...
//        listReclamation.setItems(data);
    ...
    private void Valider(ActionEvent event) throws IOException {
        ...
        PDDocument document = new PDDocument();
            ...
            contentStream.close();
            document.save("C:\\Users\\asus\\Desktop\\Projet\\file.pdf");
            document.close();
...
//    }
    ...
    @FXML
    private void NumLivreur(ActionEvent event) {
    }
    }
